...
class CardSelectionVC: UIViewController {
    ...
    let restartButton = CWButton(backgroundColor: .systemGreen, title: "Restart", systemImagename: "arrow.clockwise.circle.fill")
    let rulesButton = CWButton(backgroundColor: .systemBlue, title: "Rules", systemImagename: "list.bullet.rectangle.portrait.fill")
